...
var=['minwage','minwage2','pretax', 'pretax2','prerealinterest','prerealinterest2','prespending','prespending2','agriculture','services','preunemployment','kWhcapita','agriculture2','services2','preunemployment2','kWhcapita2']
